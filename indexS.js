...
function hasThreeInARow() {
    ...
    isLine(11, 8, 9) || isLine(0, 4, 8) || isLine(1, 5, 9) ||
    isLine(2, 6, 10) || isLine(3, 7, 11) || isLine(0, 5, 10) ||
    isLine(1, 6, 11) || isLine(2, 7, 8) || isLine(3, 4, 9) ||
    isLine(0, 7, 10) || isLine(1, 4, 11) || isLine(2, 5, 8) ||
    isLine(3, 6, 9))
}
